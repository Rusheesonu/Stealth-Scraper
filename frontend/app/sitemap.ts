 ...
 *
 * /templates is excluded — it requires auth and redirects to /login.
 * Dynamic per-template pages are intentionally omitted for launch; we'll
 * add them post-launch with an API-driven generator.
 */
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/status`, changeFrequency: 'daily', priority: 0.5, lastModified: now },
    { url: `${base}/refund-policy`, changeFrequency: 'monthly', priority: 0.3, lastModified: now },
