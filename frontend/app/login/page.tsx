...
// useSearchParams() requires a Suspense boundary as of Next.js 13+; without
// it, the static prerender step fails the build. Split the inner component
// so the boundary wraps just the part that reads search params.
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4">
      <Suspense
        fallback={
          <div className="w-full max-w-sm">
            <div className="h-7 w-20 mb-2 rounded bg-zinc-900/60 animate-pulse" />
            <div className="h-4 w-40 mb-6 rounded bg-zinc-900/40 animate-pulse" />
            <div className="h-10 w-full mb-3 rounded bg-zinc-900/40 animate-pulse" />
            <div className="h-10 w-full rounded bg-zinc-900/40 animate-pulse" />
          </div>
        }
      >
        <LoginForm />
